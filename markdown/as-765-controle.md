...
- **Encerramento do conteúdo**: 30/11/2026
- **Avaliação integradora**: 14/12/2026, com duração de quatro horas-aula

> 🗓️ O encontro originalmente previsto para 28/09 foi transferido para **quarta-feira, 07/10**. O horário e a sala desse encontro excepcional serão confirmados no ambiente da disciplina.
...
- 📊 **[Linearização de sistemas (PDF)](../courses/as765/2026/slides-03-linearizacao-as765-2026.pdf)**
- 📊 **[Transformada de Laplace (PDF)](../courses/as765/2026/slides-04-laplace-as765-2026.pdf)**

### Aula 1 — 31/08/2026 — Introdução, modelagem e linearização
...
- aproximadamente 2h30 para apresentação da disciplina e modelagem;
- aproximadamente 1h30 para pontos de operação, variáveis de desvio e linearização escalar.

### Aula 2 — 14/09/2026 — Linearização e transformada de Laplace
...
- aproximadamente 1h30 para concluir linearização e validação;
- aproximadamente 2h30 para transformada de Laplace e solução de EDOs.
...
- **05/10 — Capítulo 5**: respostas temporais, índices de desempenho, dinâmica dominante e erro em regime.
- **07/10 — Capítulo 6**: estabilidade BIBO e interna, equação característica e critério de Routh–Hurwitz. Reposição de 28/09.
...
- **16/11 — Capítulo 10**: Lugar Geométrico das Raízes e projeto de controladores.
- **23/11 — Capítulo 11**: funções de sensibilidade, compensadores e projeto no domínio da frequência.
- **30/11 — Capítulo 12**: controle em espaço de estados, LQR/LQI e observadores. Encerramento do conteúdo.
